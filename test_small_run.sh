...
/apps/SPACK/0.19.0/opt/linux-almalinux8-icelake/gcc-8.5.0/intel-oneapi-mpi-2021.7.1-f7feyqf46fk4dwyew7km6nsiitbcb2aa/mpi/2021.7.1/bin/mpirun -np 144 --map-by ppr:9:numa:pe=1   ${POT3D_HOME}/bin/pot3d2_impi > pot3d.log
echo "Done!"
