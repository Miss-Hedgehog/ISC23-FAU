...
FFLAGS="-O3  -stdpar-multicore -acc-multicore -march=native -mp"
...
POT3D_CUSPARSE=0
CCFLAGS="-O3 -stdpar-multicore -acc-multicore -mp -march=native"
...
cp ${POT3D_HOME}/src/pot3d ${POT3D_HOME}/bin/pot3d2_impi
echo "Done!"
